      ...
      <div className="flex flex-col bg-white">
        <div className="flex justify-center items-center px-16 py-20 w-full bg-slate-200 max-md:px-5 max-md:max-w-full">
          <div className="flex flex-col mt-24 mb-20 max-w-full w-[1266px] max-md:my-10">
            <div className="self-center text-8xl font-bold text-center text-sky-800 leading-[69.72px] max-md:max-w-full max-md:text-4xl">
              Grow with NextBẹwẹ
            </div>
            <div className="mt-24 text-4xl text-justify leading-[60px] text-neutral-600 max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex flex-col items-center py-20 pl-20 w-full bg-white max-md:pl-5 max-md:max-w-full">
          <div className="mt-1.5 w-full max-w-[1546px] max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col">
              ...
              <div className="flex flex-col ml-5 w-1/5 max-md:ml-0 max-md:w-full">
                <img
                  loading="lazy"
                  srcSet="..."
                  className="shrink-0 self-stretch my-auto max-w-full border border-black border-solid aspect-[0.53] w-[294px] max-md:mt-10"
                />
              </div>
            </div>
          </div>
          <div className="flex gap-4 mt-8">
            <div className="shrink-0 bg-green-500 rounded-full h-[22px] w-[22px]" />
            <div className="shrink-0 rounded-full border border-green-500 border-solid h-[22px] stroke-[1px] w-[22px]" />
            <div className="shrink-0 rounded-full border border-green-500 border-solid h-[22px] stroke-[1px] w-[22px]" />
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center items-center self-center p-20 mt-20 max-w-full text-center text-sky-800 bg-sky-800 bg-opacity-10 rounded-[70px] w-[1199px] max-md:px-5 max-md:mt-10">
