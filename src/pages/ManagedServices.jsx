...
import RemoteTeam3 from "../assets/laptop.png";
    ...
    <div>
      ...
      <TextImageSection
        ...
        paragraph={
          <>
            <p>
              We offer software development services to help businesses achieve
              their goals and stay ahead in today`&apos;`s digital landscape.
              Our team of skilled developers specialises in various technologies
              and industries, ensuring that we can cater to your unique needs
            ...
            <ul className="list-disc list-inside mt-4 ml-6">
              ...
              <li className="mt-2">
                Data protection: We prioritise intellectual property protection
                and data security by implementing industry-standard security
                protocols and adhering to strict confidentiality agreements to
                safeguard your sensitive data and proprietary assets.
              </li>
            </ul>
          </>
        }
        ...
        paragraph={
          <>
            <p>
              ...
              leverages cutting-edge tools and industry best practices to ensure
              accurate and timely financial reporting, budgeting, forecasting,
              and analysis.
            </p>
            <ul className="list-disc list-inside mt-4 ml-6">
              <li className="mt-2">
              ...
              <li className="mt-2">
                Financial reporting and analysis: We provide detailed financial
                reporting and analysis, delivering insightful data to support
              ...
              <li className="mt-2">
                Accounts payable and Receivables management: We manage accounts
                payable and receivables, ensuring timely payments and
