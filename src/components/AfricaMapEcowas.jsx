...
import mapData from "./data/countries.json"; // Update with the actual path
import "leaflet/dist/leaflet.css";
import "./AfricaMap.css"; // Ensure the CSS file is imported
import L from "leaflet";

function AfricaMapEcowas() {
...
export default AfricaMapEcowas;
